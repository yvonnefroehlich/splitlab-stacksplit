...
str ={['\rm  Event: \bf' sprintf(['%s (%03.0f) %02.0f:%02.0f  %6.2f\\circ N %6.2f\\circ E  %.0f km  \\rmMw = \\bf%3.1f'] ,thiseq.dstr, thiseq.date([7 4 5]) ,thiseq.lat, thiseq.long, thiseq.depth, thiseq.Mw) ];
    ...
    ['\rminit.Pol.:  \bf' sprintf(['%5.1f'  char(186)],pol) '  \rmFilter: \bf' sprintf('%.3f Hz - %.2f Hz',thiseq.filter) '   ' SNRstr];
    '';
