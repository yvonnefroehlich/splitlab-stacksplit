...
% 2021
%
% modification to fix bug in SplitLab of unconsidered msec of start time (SLmsec)
%
%==========================================================================
...
if config.UseHeaderTimes | strcmp(config.FileNameConvention, '*.e; *.n; *.z')
    ...
    msgbox( {'When extracting the \bfstart time\rm from the \bffile name\rm be sure that this time is \bf\itreally\rm the exact \bfstart time\rm of the \bftrace\rm!'}, ...
    ...
    switch config.FileNameConvention
        ...
        case 'mseed2sac1'
			...
			msgbox( 'Only correct for \bfzero milliseconds\rm!', ...
        ...
        case 'YYYY_MM_DD_hhmm_stnn.sac.e';
			...
			% YF add waring 2021/Nov/28
			msgbox( 'Only correct for \bfzero seconds\rm!', ...
                    'Check seconds' ,'warn', ...
                    struct('WindowStyle',{'modal'},'Interpreter',{'tex'}) );
